...
======================
Dapper - possivel implementar comandos sql diretamente
	...
	- Pode ser criado quantos repositorios forem nescessarios, esses repositorios podem conter suas interfaces na camada de Application ou Dominio 
	e dua implementação deve ser realizada na camda de Infraestrutura
	
Entity Framework - possivel buscar por entidades mapeadas
	...
	Include() ou se deve criar um objeto com Select()(existem outros comandos mas não vou citar todos) 
...
[DbContext]
=======================
Existe alguns contextos de banco de dados o Principal e mais complexo é o que no momento utiliza conexto de http request 
...
biblioteca, motivos:
	- não tem que referenciar em outras aplicações
	- permite trocar a biblioteca em apenas um ponto(onde implementou)
...
=======================
Domain:
	- camada de dominio onde temos entidades e coisas mais gerais sobre a aplicacao
...
Infraestrutura:
	...
	- Implementação de comucações externas

UI:
	- Somente entrada e saida de dados sem grandes implementações aqui
